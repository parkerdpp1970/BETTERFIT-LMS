...
const AssessorDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* 1. BRANDED HEADER */}
      <div className="bg-[#10B981] rounded-xl p-6 text-white shadow-sm relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3.5">
          <button 
            ...
            className={`p-3.5 rounded-lg shadow-sm border flex flex-col justify-center min-h-[90px] transition-all group text-left ${
                ...
                ? 'bg-[#D1FAE5]/40 border-[#10B981] hover:bg-[#D1FAE5]' 
                : 'bg-white border-[#E5E7EB] hover:border-[#10B981]'
            }`}
          >
              <div className="flex items-center mb-1.5">
                  <div className={`p-2 rounded-md mr-2.5 ${
                      ASSESSOR_DATA.stats.hasNewLearners ? 'bg-[#D1FAE5] text-[#059669]' : 'bg-[#F8FAFB] text-[#10B981]'
                  }`}>
                  ...
                  <div className="flex flex-col">
                      ...
                      {ASSESSOR_DATA.stats.hasNewLearners && (
                          <span className="text-[10px] font-semibold text-[#059669]">NEW</span>
                      )}
                  </div>
              </div>
              <p className="text-xl font-bold pl-1 text-[#1A1A2E]">
          ...
          <button 
            ...
            className={`p-3.5 rounded-lg shadow-sm border flex flex-col justify-center min-h-[90px] transition-all group text-left ${
                ...
                ? 'bg-[#FEF3C7]/40 border-[#F59E0B] hover:bg-[#FEF3C7]' 
                : 'bg-white border-[#E5E7EB] hover:border-[#10B981]'
            }`}
          >
              <div className="flex items-center mb-1.5">
                  <div className={`p-2 rounded-md mr-2.5 ${
                      ASSESSOR_DATA.stats.hasNewGroups ? 'bg-[#FEF3C7] text-[#92400E]' : 'bg-[#F8FAFB] text-[#7C3AED]'
                  }`}>
                  ...
                  <div className="flex flex-col">
                      ...
                      {ASSESSOR_DATA.stats.hasNewGroups && (
                          <span className="text-[10px] font-semibold text-[#92400E]">NEW GROUP</span>
                      )}
                  </div>
              </div>
              <p className="text-xl font-bold pl-1 text-[#1A1A2E]">
          ...
          <button 
            ...
            className="bg-white p-3.5 rounded-lg shadow-sm border border-[#E5E7EB] hover:border-[#10B981] transition-all group text-left flex flex-col justify-center min-h-[90px]"
          >
              <div className="flex items-center mb-1.5">
                  <div className="p-2 rounded-md mr-2.5 bg-[#D1FAE5] text-[#059669]">
          ...
          <button 
            ...
            className="bg-white p-3.5 rounded-lg shadow-sm border border-[#E5E7EB] hover:border-[#7C3AED] transition-all group text-left flex flex-col justify-center min-h-[90px]"
          >
              <div className="flex items-center mb-1.5">
                  <div className="p-2 rounded-md mr-2.5 bg-[#E0E7FF] text-[#7C3AED]">
          ...
          <button 
            ...
            className="bg-white p-3.5 rounded-lg shadow-sm border border-[#E5E7EB] hover:border-[#06B6D4] transition-all group text-left flex flex-col justify-center min-h-[90px]"
          >
              <div className="flex items-center mb-1.5">
                  <div className="p-2 rounded-md mr-2.5 bg-[#CFFAFE] text-[#06B6D4]">
          ...
          <button 
            ...
            className={`p-3.5 rounded-lg shadow-sm border flex flex-col justify-center min-h-[90px] transition-all group text-left ${
                ...
                ASSESSOR_DATA.stats.qaReport.status === 'referrals' ? 'bg-[#FEE2E2]/40 border-[#DC2626] hover:bg-[#FEE2E2]' :
                ASSESSOR_DATA.stats.qaReport.status === 'mixed' ? 'bg-[#FEF3C7]/40 border-[#F59E0B] hover:bg-[#FEF3C7]' :
                'bg-white border-[#E5E7EB] hover:border-[#7C3AED]'
            }`}
          >
              <div className="flex items-center mb-1.5">
                   <div className={`p-2 rounded-md mr-2.5 ${
                       ASSESSOR_DATA.stats.qaReport.status === 'positive' ? 'bg-[#D1FAE5] text-[#059669]' :
                       ASSESSOR_DATA.stats.qaReport.status === 'referrals' ? 'bg-[#FEE2E2] text-[#DC2626]' :
                       ASSESSOR_DATA.stats.qaReport.status === 'mixed' ? 'bg-[#FEF3C7] text-[#92400E]' :
              ...
              <div className="text-[11px] font-semibold pl-1 text-[#1A1A2E]">
          ...
          >
              <div className="flex items-center mb-1.5">
                  <div className="p-2 rounded-md mr-2.5 bg-[#D1FAE5] text-[#10B981]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-[#E5E7EB] overflow-hidden flex flex-col">
              <div className="p-4 border-b border-[#E5E7EB] flex justify-between items-center bg-[#F8FAFB]">
                  <h3 className="text-base font-semibold text-[#1A1A2E] flex items-center">
                      <FileText className="w-4 h-4 mr-2 text-[#10B981]" />
                      Pending Submissions
                  </h3>
                  <button onClick={() => navigate('/assessor/pending')} className="text-xs font-medium text-[#10B981] hover:underline">View All Queue</button>
              </div>
              <div className="flex-1 overflow-y-auto max-h-[400px] p-0">
                  <table className="w-full text-left border-collapse">
                        <thead className="bg-[#F8FAFB] sticky top-0 z-10 border-b border-[#E5E7EB] text-xs font-medium text-[#6B7280]">
                            <tr>
                        ...
                        <tbody className="divide-y divide-[#E5E7EB] text-xs">
                            {PENDING_SUBMISSIONS.map(item => (
                                <tr key={item.id} className="hover:bg-[#F8FAFB] transition-colors">
                                    <td className="px-5 py-3.5 font-medium text-[#1A1A2E] flex items-center gap-2.5">
                                    ...
                                    <td className="px-5 py-3.5 text-[#6B7280]">
                                        <div className="flex items-center gap-1.5">
                                            {item.type === 'Video' ? <Video className="w-3.5 h-3.5 text-[#7C3AED]" /> : <FileText className="w-3.5 h-3.5 text-[#06B6D4]" />}
                                            {item.submission}
                                        </div>
                                    </td>
                                    <td className="px-5 py-3.5">
                                        <span className={item.status === 'Overdue Review' ? 'text-[#DC2626] font-medium' : 'text-[#1A1A2E]'}>{item.submitted}</span>
                                        {item.status === 'Overdue Review' && <span className="text-[10px] ml-2 badge-warning">Overdue</span>}
                                    </td>
                                    <td className="px-5 py-3.5 text-right">
                                        <button onClick={() => navigate('/assessor/pending')} className="btn-primary py-1.5 px-3 text-xs">
                                            Mark Now
                                        </button>
                                    </td>
                                </tr>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-[#E5E7EB] overflow-hidden flex flex-col">
              <div className="p-4 border-b border-[#E5E7EB] flex justify-between items-center bg-[#F8FAFB]">
                  <h3 className="text-base font-semibold text-[#1A1A2E] flex items-center">
                      <CalendarIcon className="w-4 h-4 mr-2 text-[#7C3AED]" />
                      Your Schedule
                  </h3>
                  <button onClick={() => navigate('/calendar')} className="text-[#6B7280] hover:text-[#1A1A2E]">
                      <MoreHorizontal className="w-4 h-4" />
                  </button>
              </div>
              <div className="p-4 space-y-2.5 flex-1 overflow-y-auto max-h-[400px]">
                  {UPCOMING_EVENTS.map(event => (
                      <div key={event.id} className={`bg-white border border-[#E5E7EB] rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow ${event.color}`}>
                          <div className="flex justify-between items-start mb-1">
                              <span className="text-[10px] font-medium text-[#6B7280] uppercase tracking-wide">{event.date} • {event.time}</span>
                              <span className="text-[10px] bg-[#F8FAFB] px-2 py-0.5 rounded text-[#6B7280] border border-[#E5E7EB]">{event.type}</span>
                          </div>
                          <h4 className="font-semibold text-[#1A1A2E] text-xs">{event.title}</h4>
                      </div>
                  ))}
                  <button onClick={() => navigate('/calendar')} className="w-full py-2 text-center text-xs font-medium text-[#10B981] hover:underline border border-dashed border-[#E5E7EB] rounded-lg mt-2 hover:bg-[#F8FAFB]">
                      + Add New Event
                  </button>
              </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {/* Engagement Chart */}
          <div className="bg-white rounded-lg shadow-sm border border-[#E5E7EB] p-5 flex flex-col">
              <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-semibold text-[#1A1A2E] flex items-center">
                      <TrendingUp className="w-4 h-4 mr-2 text-[#10B981]" /> Activity Trends
                  </h3>
                  <select className="text-xs border border-[#E5E7EB] rounded-md p-1.5 bg-white text-[#1A1A2E] focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981]">
              ...
              <div className="h-40 w-full flex-1">
                  <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={ASSESSOR_DATA.activityData}>
                          ...
                          <Area type="monotone" dataKey="access" stroke="#10B981" strokeWidth={2} fillOpacity={1} fill="url(#colorEngagementMini)" />
                      </AreaChart>
                  </ResponsiveContainer>
              </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-[#E5E7EB] p-5">
              <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-semibold text-[#1A1A2E] flex items-center">
                      <AlertCircle className="w-4 h-4 mr-2 text-[#DC2626]" /> Attention Needed
                  </h3>
                  <button className="text-xs font-medium text-[#10B981] hover:underline">View All</button>
              </div>
              <div className="space-y-2.5">
                  {ASSESSOR_DATA.leastActive.slice(0, 3).map(learner => (
                      <div key={learner.id} className="flex items-center justify-between p-2.5 bg-[#FEF2F2] rounded-lg border border-[#FEE2E2]">
                          <div className="flex items-center gap-2.5">
                              <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center text-xs font-bold text-[#DC2626] border border-[#FCA5A5]">
                                  {learner.name.charAt(0)}
                              </div>
                              <div>
                                  <p className="text-xs font-semibold text-[#1A1A2E]">{learner.name}</p>
                                  <p className="text-[10px] text-[#DC2626]">Inactive: {learner.lastLogin}</p>
                              </div>
                          </div>
                          <button onClick={() => navigate('/messages')} className="p-1.5 bg-white text-[#1A1A2E] rounded hover:text-[#10B981] shadow-sm border border-[#E5E7EB]">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E5E7EB] overflow-hidden">
          <div className="p-5 border-b border-[#E5E7EB] bg-[#F8FAFB] flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                  <h2 className="text-base font-semibold text-[#1A1A2E]">Learner Management</h2>
                  <p className="text-xs text-[#6B7280]">Monitor progress and submissions</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative">
                      <select 
                          ...
                          className="w-full sm:w-48 pl-3 pr-8 py-2 border border-[#E5E7EB] rounded-md text-xs font-medium focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] bg-white text-[#1A1A2E]"
                      >
                  ...
                  <div className="relative">
                      <input 
                          ...
                          className="w-full sm:w-64 pl-9 pr-3 py-2 border border-[#E5E7EB] rounded-md text-xs focus:ring-1 focus:ring-[#10B981] focus:border-[#10B981] text-[#1A1A2E]"
                      />
          ...
          <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-[#E5E7EB]">
                  <thead className="bg-[#F8FAFB]">
                      <tr>
                          <th className="px-5 py-3 text-left text-xs font-medium text-[#6B7280]">Learner Name</th>
                          <th className="px-5 py-3 text-left text-xs font-medium text-[#6B7280]">Group</th>
                          <th className="px-5 py-3 text-left text-xs font-medium text-[#6B7280]">Course</th>
                          <th className="px-5 py-3 text-left text-xs font-medium text-[#6B7280]">Course Progress</th>
                          <th className="px-5 py-3 text-left text-xs font-medium text-[#6B7280]">Last Active</th>
                          <th className="px-5 py-3 text-right text-xs font-medium text-[#6B7280]">Actions</th>
                      </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-[#E5E7EB]">
                      {filteredLearners.length > 0 ? (
                          filteredLearners.map(learner => (
                              <tr key={learner.id} className="hover:bg-[#F8FAFB] transition-colors group">
                                  <td className="px-5 py-3.5 whitespace-nowrap">
                                      <div className="flex items-center">
                                          <div className="h-7 w-7 rounded-full bg-[#D1FAE5] text-[#059669] flex items-center justify-center font-semibold text-xs mr-2.5">
                                              {learner.name.split(' ').map(n => n[0]).join('')}
                                          </div>
                                          <div>
                                              <div className="text-xs font-semibold text-[#1A1A2E]">{learner.name}</div>
                                              <div className="text-[10px] text-[#6B7280]">#{learner.id}</div>
                                          </div>
                                      </div>
                                  </td>
                                  <td className="px-5 py-3.5 whitespace-nowrap">
                                      <span className="text-xs font-medium bg-[#F8FAFB] border border-[#E5E7EB] px-2 py-0.5 rounded text-[#1A1A2E]">
                                          {learner.group}
                                      </span>
                                  </td>
                                  <td className="px-5 py-3.5 whitespace-nowrap">
                                      <div className="text-xs text-[#1A1A2E]">{learner.course}</div>
                                  </td>
                                  <td className="px-5 py-3.5 whitespace-nowrap align-middle">
                                      <div className="w-full max-w-[140px]">
                                          <div className="flex justify-between text-[11px] mb-1">
                                              <span className="font-semibold text-[#1A1A2E]">{learner.progress}%</span>
                                          </div>
                                          <div className="w-full bg-[#E5E7EB] rounded-full h-1.5 overflow-hidden">
                                              <div 
                                                  className={`h-full rounded-full ${learner.status === 'Lagging' ? 'bg-[#DC2626]' : 'bg-[#10B981]'}`} 
                                  ...
                                  <td className="px-5 py-3.5 whitespace-nowrap text-right">
                                      <button 
                                          ...
                                          className="text-[#10B981] hover:text-[#059669] font-medium text-xs flex items-center justify-end group-hover:underline"
                                      >
          ...
          <div className="px-5 py-3.5 border-t border-[#E5E7EB] bg-[#F8FAFB] flex justify-between items-center text-xs text-[#6B7280]">
              <span>Showing {filteredLearners.length} learners</span>
              <button className="font-medium text-[#10B981] hover:underline" onClick={() => navigate('/assessor/learners')}>View Full Roster</button>
          </div>
      </div>
    </div>
  );
