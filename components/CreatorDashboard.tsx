  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 relative" onClick={() => setIsCreateMenuOpen(false)}>
                          ...
                          <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden z-[100] animate-in fade-in zoom-in duration-200">
                              <div className="p-2 space-y-1">
                                  <button onClick={() => handleCreateOptionClick('ai')} className="w-full text-left px-3.5 py-2.5 hover:bg-emerald-50 rounded-lg flex items-center group transition-colors">
                                      <Sparkles className="w-4 h-4 mr-3 text-secondary group-hover:scale-110 transition-transform" />
                                      <div>
                                          <span className="block text-xs font-semibold text-on-surface">Create with AI</span>
                                  ...
                                  <button onClick={() => handleCreateOptionClick('blank')} className="w-full text-left px-3.5 py-2.5 hover:bg-gray-50 rounded-lg flex items-center group transition-colors">
                                      <Edit2 className="w-4 h-4 mr-3 text-gray-500 group-hover:text-primary" />
                                      <span className="text-xs font-semibold text-on-surface">Create blank</span>
                                  </button>
                                  <button onClick={() => handleCreateOptionClick('ppt')} className="w-full text-left px-3.5 py-2.5 hover:bg-gray-50 rounded-lg flex items-center group transition-colors">
                                      <FileIcon className="w-4 h-4 mr-3 text-gray-500 group-hover:text-primary" />
                                      <span className="text-xs font-semibold text-on-surface">Create from PowerPoint</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <div className="bf-card overflow-hidden flex flex-col h-full">
              <div className="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-50/70 gap-3">
                  <h2 className="text-sm font-semibold text-on-surface flex items-center whitespace-nowrap">
                      <BookOpen className="w-4 h-4 mr-2 text-primary" /> Recent Courses
                  </h2>
                  ...
                  <div className="relative w-full sm:w-auto">
                      <input 
                          ...
                          className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-shape-md focus:border-primary focus:ring-2 focus:ring-primary/20 w-full text-on-surface bg-white"
                      />
                  ...
                  <div className="space-y-3">
                      {filteredCourses.length > 0 ? (
                          filteredCourses.map(course => (
                              <div key={course.id} className="flex items-center justify-between p-3.5 bg-white border border-gray-200 rounded-lg hover:border-primary-fixed-dim hover:shadow-sm transition-all group cursor-pointer">
                                  <div className="flex items-center min-w-0 mr-2">
                                      <div className="h-12 w-16 bg-gray-100 rounded-lg overflow-hidden mr-3 relative shrink-0 border border-gray-200 flex items-center justify-center">
                                            <div className={`absolute inset-0 opacity-20 ${course.id % 2 === 0 ? 'bg-secondary' : 'bg-primary'}`}></div>
                                            <ImageIcon className="w-5 h-5 text-gray-400 relative z-10" />
                                      </div>
                                      
                                      <div className="min-w-0">
                                          <h3 className="font-semibold text-xs text-on-surface truncate">{course.title}</h3>
                                  ...
                                  <div className="flex items-center shrink-0">
                                      <button 
                                          ...
                                          className="p-1.5 text-gray-400 hover:text-primary hover:bg-primary-container rounded-md transition-colors" 
                                          title="Edit Course"
                                      >
          ...
          <div className="bf-card overflow-hidden flex flex-col h-full">
              <div className="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-50/70 gap-3">
                  <h2 className="text-sm font-semibold text-on-surface flex items-center whitespace-nowrap">
                      <LayoutTemplate className="w-4 h-4 mr-2 text-on-surface-variant" /> Recent Forms
                  </h2>
                      ...
                      {filteredForms.length > 0 ? (
                          filteredForms.map(form => (
                              <div 
                                  ...
                                  className="flex items-center justify-between p-3.5 bg-white border border-gray-200 rounded-lg hover:border-primary-fixed-dim hover:shadow-sm transition-all group cursor-pointer"
                              >
                                  <div className="flex items-center min-w-0 mr-2">
                                      ...
                                      <div className="min-w-0">
                                          <h3 className="font-semibold text-xs text-on-surface truncate">{form.title}</h3>
                                          <div className="flex gap-2 text-[11px] text-gray-500 mt-0.5">
              ...
              <div className="p-3.5 bg-gray-50/70 border-t border-gray-100 text-center">
                   <button onClick={() => navigate('/creator/form-builder')} className="text-xs font-semibold text-gray-600 hover:text-on-surface-variant flex items-center justify-center w-full transition-colors">
          ...
          <div className="bf-card overflow-hidden flex flex-col h-full">
              <div className="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-50/70 gap-3">
                  <h2 className="text-sm font-semibold text-on-surface flex items-center whitespace-nowrap">
                      <Megaphone className="w-4 h-4 mr-2 text-secondary" /> Recent Banners
                  </h2>
                  <div className="relative w-full sm:w-auto">
                      <input 
                          type="text" 
              ...
              <div className="p-4 sm:p-5 flex-1">
                  <div className="space-y-3">
                      {filteredBanners.map(banner => (
                          <div key={banner.id} className="flex items-center justify-between p-3.5 bg-white border border-gray-200 rounded-lg hover:border-primary-fixed-dim hover:shadow-sm transition-all group cursor-pointer" onClick={() => navigate('/creator/banner-builder')}>
                              <div className="flex items-center min-w-0 mr-2">
                                  ...
                                  <div className="min-w-0">
                                      <h3 className="font-semibold text-on-surface text-xs truncate">{banner.title}</h3>
                              ...
                              <div className="flex items-center shrink-0">
                                  <button className="p-1.5 text-gray-400 hover:text-secondary rounded-md transition-colors">
                                      <Edit2 className="w-4 h-4" />
                                  </button>
                              </div>
                          </div>
              ...
              <div className="p-3.5 bg-gray-50/70 border-t border-gray-100 text-center">
                   <button onClick={() => navigate('/creator/banner-builder')} className="text-xs font-semibold text-gray-600 hover:text-secondary flex items-center justify-center w-full transition-colors">
                  ...
                  <div className="p-6 sm:p-8">
                      <div className="flex justify-between items-start mb-5">
                          <h2 className="text-xl font-bold text-on-surface flex items-center">
                              <Sparkles className="w-5 h-5 mr-2.5 text-secondary" />
                              Create with AI
                          </h2>
                          <button onClick={() => setActiveModal('none')} className="text-gray-400 hover:text-on-surface transition-colors p-1"><X className="w-5 h-5" /></button>
                      </div>
                      
                      {isGenerating ? (
                          <div className="py-12 flex flex-col items-center justify-center text-center">
                              <div className="relative">
                                  <div className="w-14 h-14 border-3 border-gray-200 border-t-primary rounded-full animate-spin"></div>
                                  <Sparkles className="w-5 h-5 text-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse" />
                              </div>
                              <h3 className="mt-5 text-base font-semibold text-on-surface">Generating Course Structure...</h3>
                          ...
                          <>
                              ...
                              <textarea 
                                  className="w-full border border-gray-200 rounded-shape-md p-3.5 text-xs text-on-surface focus:ring-2 focus:ring-primary/20 focus:border-primary min-h-[140px] resize-none leading-relaxed outline-none"
                              ...
                              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  <button className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-left text-xs hover:border-primary-fixed-dim hover:bg-primary-container/40 transition-colors">
                                      <span className="block font-semibold text-primary mb-0.5">Create a 10-minute course</span>
                                      <span className="text-gray-500 text-[11px]">on customer service etiquette</span>
                                  </button>
                                  <button className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-left text-xs hover:border-primary-fixed-dim hover:bg-primary-container/40 transition-colors">
                                      <span className="block font-semibold text-primary mb-0.5">Create a 20-question quiz</span>
                                      <span className="text-gray-500 text-[11px]">on machine safety</span>
                                  </button>
                              </div>

                              <div className="mt-6 flex justify-end">
                                  <Button variant="secondary" size="sm" trailingIcon={Sparkles} onClick={handleAiGenerate}>
                                      Generate
                                  </Button>
                              </div>
                          </>
      ...
      {activeModal === 'details' && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200">
              <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden border border-gray-200 flex flex-col max-h-[90vh]">
                  <div className="bg-tertiary px-6 py-4 flex justify-between items-center text-white shrink-0">
                  ...
                  <div className="p-6 space-y-5 overflow-y-auto">
                      ...
                      <div className="space-y-2.5">
                          <label className="block text-xs font-semibold text-on-surface">Course Thumbnail</label>
                          ...
                          <div className="w-full aspect-video bg-gray-100 rounded-lg border border-gray-200 overflow-hidden relative flex items-center justify-center group">
                                {newCourseData.thumbnail ? (
                                    <>
                                        <div className={`w-full h-full ${newCourseData.thumbnail.includes('generated') ? 'bg-primary' : 'bg-gray-300' } flex items-center justify-center text-white text-xs font-semibold`}>
                          ...
                          <div className="flex bg-gray-100 p-1 rounded-lg">
                              <button 
                                  ...
                                  className={`flex-1 flex items-center justify-center py-1.5 text-xs font-semibold rounded-md transition-all ${imageTab === 'ai' ? 'bg-white text-primary shadow-xs' : 'text-gray-600 hover:text-on-surface'}`}
                              >
                                  <Sparkles className="w-3 h-3 mr-1" /> AI Generate
                              </button>
                              <button 
                                  onClick={() => setImageTab('upload')}
                                  className={`flex-1 flex items-center justify-center py-1.5 text-xs font-semibold rounded-md transition-all ${imageTab === 'upload' ? 'bg-white text-primary shadow-xs' : 'text-gray-600 hover:text-on-surface'}`}
                              >
                                  <UploadCloud className="w-3 h-3 mr-1" /> Upload
                              </button>
                              <button 
                                  onClick={() => setImageTab('web')}
                                  className={`flex-1 flex items-center justify-center py-1.5 text-xs font-semibold rounded-md transition-all ${imageTab === 'web' ? 'bg-white text-primary shadow-xs' : 'text-gray-600 hover:text-on-surface'}`}
                              >
                          ...
                          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3.5 min-h-[100px]">
                              {imageTab === 'ai' && (
                                  <div className="space-y-2.5">
                                      <input 
                                          ...
                                          className="w-full text-xs border border-gray-200 rounded-shape-md p-2.5 focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white text-on-surface outline-none"
                                      />
                                      <Button
                                          size="sm"
                                          block
                              ...
                              {imageTab === 'upload' && (
                                  <div 
                                      ...
                                      className="border border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer hover:bg-white hover:border-primary-fixed-dim transition-colors"
                                  >
                                  ...
                                  <div className="space-y-2.5">
                                      <div className="flex gap-2">
                                          <input 
                                              ...
                                              className="flex-1 text-xs border border-gray-200 rounded-shape-md p-2.5 focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white text-on-surface outline-none"
                                          />
                                          <Button variant="secondary" size="sm" iconOnly icon={Search} aria-label="Search web images" onClick={handleWebSearch} />
                                      </div>
                                           ...
                                           <div className="grid grid-cols-3 gap-2">
                                                {webResults.map((_, i) => (
                                                    <div 
                                                        ...
                                                        className="aspect-square bg-gray-200 rounded-lg cursor-pointer hover:ring-2 hover:ring-primary relative overflow-hidden group"
                                                    >
                      ...
                      <div>
                          <label className="block text-xs font-semibold text-on-surface mb-1.5">Title <span className="text-error">*</span></label>
                          <input 
                              type="text" 
                              value={newCourseData.title} 
                              onChange={(e) => setNewCourseData({...newCourseData, title: e.target.value})}
                              className="w-full border border-gray-200 rounded-shape-md p-2.5 text-xs focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white text-on-surface outline-none" 
                      ...
                      <div>
                          ...
                          <textarea 
                              ...
                              rows={3}
                              className="w-full border border-gray-200 rounded-shape-md p-2.5 text-xs focus:border-primary focus:ring-2 focus:ring-primary/20 bg-white text-on-surface outline-none resize-none" 
                              placeholder="Add a brief description..."
                          ></textarea>
                      </div>

                      <div className="flex justify-end gap-3 pt-3 shrink-0">
                          <Button variant="outlined" size="sm" onClick={() => setActiveModal('none')}>Cancel</Button>
                          <Button size="sm" arrow={false} onClick={handleFinalizeCreate}>Create</Button>
                      </div>
                  </div>
              </div>
          </div>
